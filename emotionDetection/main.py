...
@app.route('/')
def index():
    face_classifier = cv2.CascadeClassifier(r'C:\Users\HARITHA SEKAR\Emotify-Arithemania\emotionDetection\haarcascade_frontalface_default.xml')
    classifier =load_model(r'C:\Users\HARITHA SEKAR\Emotify-Arithemania\emotionDetection\model.h5')
    ...
    print(val)
    fp = open(r"C:\Users\HARITHA SEKAR\Emotify-Arithemania\new.txt","w")
    fp.write(val)
    fp.close()
    import os
    os.system(r'python C:\Users\HARITHA SEKAR\Emotify-Arithemania\songRecommender\test.py')
